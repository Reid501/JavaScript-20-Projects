...
function tellMe(joke) {
    VoiceRSS.speech({
        key: '28f248537b274ca49cb209d4670e7ff7',
        src: joke,
        hl: 'en-us',
        v: 'Linda',
        r: 0, 
...
async function getJokes(){
    let joke = '';
    const apiUrl = 'https://sv443.net/jokeapi/v2/joke/Miscellaneous,Pun,Spooky,Christmas?blacklistFlags=nsfw,religious,political,racist,sexist';
    try{
